...
import org.example.AgentsGuis.AgentGamer2_Gui;

public class AgentGamer2 extends GuiAgent {
    private AgentGamer2_Gui clientGui;
    @Override
    protected void setup() {
        System.out.println("*** Client: la méthode setup *****");
        clientGui=(AgentGamer2_Gui) getArguments()[0];
       clientGui.setAgentGamer2(this);

...
import org.example.AgentsGuis.AgentGamer1_Gui;

public class AgentGamer1 extends GuiAgent {
    private AgentGamer1_Gui clientGui;
    @Override
    protected void setup() {
        System.out.println("*** Client: la méthode setup *****");
        clientGui=(AgentGamer1_Gui) getArguments()[0];

...
import org.example.AgentsGuis.AgentBayer_Gui;

public class Bayer extends GuiAgent {
    private AgentBayer_Gui clientGui;
    @Override
    protected void setup() {
        System.out.println("*** Client: la méthode setup *****");
        clientGui=(AgentBayer_Gui) getArguments()[0];
